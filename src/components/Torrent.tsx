...
const Torrent: React.FC<{ torrentData: TorrentProps }> = ({ torrentData }) => {
  return (
    <div className="flex flex-col gap-2 justify-center items-center w-fit my-4 mx-auto py-4 px-8 bg-gray-600 text-gray-300 text-sm font-medium rounded-md shadow-md">
      <div>
